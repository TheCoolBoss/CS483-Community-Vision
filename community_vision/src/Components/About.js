...
const About = forwardRef((props, ref) => {
  ...
  return (
    <div style={{
      ...
      <h1 style={{ fontWeight: 900, userSelect: 'none', cursor: 'default' }}>At Community Vision</h1>

      <p style={{ userSelect: 'none', cursor: 'default' }}>* we value individuals * value whole lives * we begin with "yes" * we are future-oriented *
      we value independence * we value expanding the conversation * we value community *
         we value callaboration * we value innovation * </p>

      <p1 style={{ userSelect: 'none', cursor: 'default' }}>We work with natural support systems including an individual’s family, friends,
      ...
      <p2 style={{ userSelect: 'none', cursor: 'default' }}>Our work is rooted in the belief that all people, regardless of perceived ability,
